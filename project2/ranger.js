function data8info(){
    prof = data8.proficiencies;
    equip = data8.starting_equipment;
    equipc = data8.starting_equipment_options;
    ...
    strokeWeight(0);
    textFont(headfont);
    text(data8.name,width/2,100);
    fill(255, 239, 196);
    textFont('Courier New');
    textSize(16);
    text('Hit die: ' + data8.hit_die, width/2, 200);
