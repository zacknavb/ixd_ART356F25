function data6info(){
    prof = data6.proficiencies;
    equip = data6.starting_equipment;
    equipc = data6.starting_equipment_options;
    ...
    strokeWeight(0);
    textFont(headfont);
    text(data6.name,width/2,100);
    fill(255, 239, 196);
    textFont('Courier New');
    textSize(16);
    text('Hit die: ' + data6.hit_die, width/2, 200);
