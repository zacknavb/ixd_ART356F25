function data12info(){
    prof = data12.proficiencies;
    equip = data12.starting_equipment;
    equipc = data12.starting_equipment_options;
    ...
    strokeWeight(0);
    textFont(headfont);
    text(data12.name,width/2,100);
    fill(255, 239, 196);
    textFont('Courier New');
    textSize(16);
    text('Hit die: ' + data12.hit_die, width/2, 200);
