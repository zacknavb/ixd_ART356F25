function data7info(){
    prof = data7.proficiencies;
    equip = data7.starting_equipment;
    equipc = data7.starting_equipment_options;
    ...
    strokeWeight(0);
    textFont(headfont);
    text(data7.name,width/2,100);
    fill(255, 239, 196);
    textFont('Courier New');
    textSize(16);
    text('Hit die: ' + data7.hit_die, width/2, 200);
